...
import { FEED_INIT, FEED_SUCCESS, FEED_ERROR, FEED_CLOSED, FEED_CLOSE, FEED_MESSAGE } from "../constants";
...
export const feedInitAction = (url: string | URL) => (dispatch: TAppDispatch) => {
