...
import { DRAG_MOVED_CONSTRUCTOR_ELEMENT, moveIngridient } from '../../services/actions/constructors-ingredients'
import { useRef } from 'react'
import { useDrag } from 'react-dnd'
import { DROP_MOVED_ELEMENT } from '../../services/actions/constructors-ingredients'
import { dropMovedIngredient } from '../../services/actions/constructors-ingredients'
import PropTypes from 'prop-types';


export default function BurgerConstructorElement({ id, item, index, type, isLocked, toClose, typeOfText, className, toDrag }) {
    ...
    return (
        !isDrag &&
        <li className={className} ref={item.type !== 'bun' ? ref : null} style={{opacity}} onDrag ={toDrag}>
